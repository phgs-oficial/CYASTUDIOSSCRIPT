...
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://138698283986745", BackgroundTransparency = 0 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})


local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://138698283986745" })
local TrollTab = Window:MakeTab({ "Trolling Map", "map" })
local trava = Window:MakeTab({ "Glitch", "axe" })
...
InfoTab:AddDiscordInvite({
    ...
    Logo = "rbxassetid://138698283986745",
    Invite = "https://discord.gg/JuC93peY7J",
}) 

InfoTab:AddSection({ "Script informations" })
InfoTab:AddSection({ "Welcome to CYA STUDIOS HUB!" })
InfoTab:AddSection({ "versão da CYA FOX: 1.5" })
-- fim info tab
...
TrollTab:AddButton({Name = "SkyBox ",
Callback = function()
